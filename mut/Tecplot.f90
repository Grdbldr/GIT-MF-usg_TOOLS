...
!*************************************************************************old plot_data declarations  end here
   ...
   !------------------------------------------------------------------------
   subroutine ProcessTecplot(FnumTG) !--- Process Tecplot instructions
        implicit none
    
        integer :: FnumTG
    
        do
            read(FnumTG,'(a)',iostat=status,end=10) Tecplot_CMD
            call Msg('!-----------------------')
            ...
            if(index(Tecplot_CMD, Tecplot_hsplot2012_CMD) /= 0) then
                ...
                read(FnumTG,*) TecplotTimeOffset

            else if(index(Tecplot_CMD, Tecplot_ReadWrite_szplt_CMD) /= 0) then
                call Tecplot_ReadWrite_szplt(FNumTG)
...
!		    endif
   ...
   subroutine BuildCustomZoneNames(medium, global)
    ...
    subroutine Tecplot_ReadWrite_szplt(FNumTG)
    !
